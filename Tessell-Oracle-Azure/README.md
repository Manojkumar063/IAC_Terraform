# 🗄️ Tessell Oracle DB on Azure — Terraform Project

Automated provisioning of Oracle 19c database on Azure using Tessell DBaaS and Terraform.
...
- Azure subscription (managed by Tessell)
